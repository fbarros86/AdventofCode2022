...
with open("input.txt","r") as f:
    ...
    spacetoDelete = (directories["/"].fsize + directories["/"].sizeDirs) - 40000000
    min = (directories["/"].fsize + directories["/"].sizeDirs)
    for dir in directories.values():
        if (dir.fsize+dir.sizeDirs>= spacetoDelete and dir.fsize+dir.sizeDirs<min ):
            min=dir.fsize+dir.sizeDirs 
    print(min)
